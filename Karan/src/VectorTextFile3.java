...
public class VectorTextFile3 {
	...
	public static final int MinMergeSort = 37;
	...
	{		
		...
		try{
			...
			watch.stop();
			System.out.println("Time Taken For MergeSort :" + watch.getTime());
			// Check for errors:
			if (m_Sorted == false)
			{
	...
	private void InsertionSortWords(int Begin, int End) throws Exception
	{
		...
		int iMaxSorted = 0;
		if(Begin < 0 || End >= m_FileWordCount )
			throw new Exception ("Incorrect Begin/End Values");
		// Check for errors
